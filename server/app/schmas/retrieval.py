from __future__ import annotations  # 优化类型注解写法

from pydantic import BaseModel, Field # 定义并校验接口数据结构

# BaseModel
# 定义一个数据模型类，用于校验入参类型、自动转换、生成 JSON schema、把 dict/JSON 转成对象，或对象转 dict/JSON
